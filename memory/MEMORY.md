...
- [Private corpus location](private-corpus-location.md) — a recovered private-v7 can migrate identity-preservingly; absent historical data needs an explicit private-v19 replacement and fresh runtime pins
